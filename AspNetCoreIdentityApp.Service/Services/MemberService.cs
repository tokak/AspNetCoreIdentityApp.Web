...
namespace AspNetCoreIdentityApp.Service.Services
{
    public class MemberService : IMemberService
    {
        ...
        public async Task<UserViewModelMember> GetUserViewModelByUserNameAsync(string userName)
        {
            var currentUser = (await _userManager.FindByNameAsync(userName))!;
            return new UserViewModelMember
            {
        ...
        public List<ClaimsViewModel> GetClaims(ClaimsPrincipal principal)
        {
           return principal.Claims.Select(x => new ClaimsViewModel()
            {
                Issuser = x.Issuer,
                Type = x.Type,
                Value = x.Value
